...
if ( !class_exists( "PrsoFrmAdvUploaderOptions" ) ) {
	class PrsoFrmAdvUploaderOptions {

		public $args = array();
		public $sections = array();
		public $theme;
		public $ReduxFramework;
		public $text_domain 	= PRSOFRMADVUPLOADER__DOMAIN;
		public $options_name 	= PRSOFRMADVUPLOADER__OPTIONS_NAME;
		...
		**/
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'display_name'			=> __( 'Formidable Advanced Uploader', $this->text_domain ), // Name that appears at the top of your panel
				'display_version'		=> PRSOFRMADVUPLOADER__VERSION, // Version that appears at the top of your panel
				'menu_type'          	=> 'menu', //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
				'allow_sub_menu'     	=> true, // Show the sections below the admin menu item or not
				'menu_title'			=> __( 'Formidable Adv Uploader', $this->text_domain ),
	            'page'		 	 		=> __( 'Formidable Adv Uploader', $this->text_domain ),
